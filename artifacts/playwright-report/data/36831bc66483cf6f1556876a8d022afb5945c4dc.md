...
- Name: user-flows/input-validation.spec.js >> Input Validation — Food Tab >> ADD FOOD is blocked with an empty amount field
- Location: tests/user-flows/input-validation.spec.js:15:3
