...
- Name: user-flows/input-validation.spec.js >> Input Validation — Workout Tab >> estimated calorie preview is only shown when sets > 0
- Location: tests/user-flows/input-validation.spec.js:99:3
