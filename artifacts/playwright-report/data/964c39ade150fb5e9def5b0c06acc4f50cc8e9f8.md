...
- Name: user-flows/dashboard-navigation.spec.js >> Dashboard & Core Navigation Flow >> should navigate between tabs correctly
- Location: tests/user-flows/dashboard-navigation.spec.js:15:3
...
Locator: getByText('MACROS TODAY')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('MACROS TODAY')
