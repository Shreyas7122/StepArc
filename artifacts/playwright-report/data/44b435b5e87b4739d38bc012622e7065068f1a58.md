...
- Name: user-flows/header-menu.spec.js >> Header User Menu >> Sign Out button has sufficient touch target size (min 44px height)
- Location: tests/user-flows/header-menu.spec.js:38:3
